...
# obj.subj.rc <- list(name = "ORC vs. SRC",
#                 description ="Object vs Subject Relative Clauses",
#                 conditions = list(
...
#                   ## "The dog that the cats chased WAS..."
#                   list(condition = "ORC",
#                        num.experimental.subjects = 40,
#                        num.experimental.items = 10,                                              
